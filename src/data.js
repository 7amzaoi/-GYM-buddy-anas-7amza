...
export const EXERCISES = {
  strength: [
    ...
    { id: 's13', name: 'Front Squat', muscles: 'Quads, Core', sets: 4, reps: '6-8', icon: '🦵' },
    { id: 's14', name: 'Lat Pulldown', muscles: 'Back, Biceps', sets: 4, reps: '10-12', icon: '🔝' },
    { id: 's15', name: 'Seated Cable Row', muscles: 'Back, Biceps', sets: 4, reps: '10-12', icon: '🚣' },
    { id: 's16', name: 'Incline Dumbbell Press', muscles: 'Chest, Shoulders', sets: 4, reps: '8-10', icon: '🏋️' },
    { id: 's17', name: 'Dumbbell Shoulder Press', muscles: 'Shoulders, Triceps', sets: 4, reps: '8-10', icon: '🏋️' },
    { id: 's18', name: 'Push-Up', muscles: 'Chest, Triceps', sets: 3, reps: '12-20', icon: '💪' },
    { id: 's19', name: 'Barbell Hip Thrust', muscles: 'Glutes, Hamstrings', sets: 4, reps: '10-12', icon: '🦵' },
    { id: 's20', name: 'Walking Lunge', muscles: 'Quads, Glutes', sets: 3, reps: '12', icon: '🚶' },
    { id: 's21', name: 'Calf Raise', muscles: 'Calves', sets: 4, reps: '12-15', icon: '🦵' },
    { id: 's22', name: 'Upright Row', muscles: 'Shoulders, Back', sets: 3, reps: '10-12', icon: '🏋️' },
    { id: 's23', name: 'Close-Grip Bench Press', muscles: 'Triceps, Chest', sets: 4, reps: '8-10', icon: '🏋️' },
    { id: 's24', name: 'Tricep Pushdown', muscles: 'Triceps', sets: 3, reps: '12-15', icon: '💪' },
    { id: 's25', name: 'Barbell Curl', muscles: 'Biceps', sets: 3, reps: '10-12', icon: '💪' },
    { id: 's26', name: 'Concentration Curl', muscles: 'Biceps', sets: 3, reps: '12', icon: '💪' },
    { id: 's27', name: 'Barbell Shrug', muscles: 'Back, Shoulders', sets: 3, reps: '12-15', icon: '🏋️' },
    { id: 's28', name: 'T-Bar Row', muscles: 'Back, Biceps', sets: 4, reps: '8-10', icon: '💪' },
    { id: 's29', name: 'Good Morning', muscles: 'Hamstrings, Back', sets: 3, reps: '10-12', icon: '🦵' },
    { id: 's30', name: "Farmer's Carry", muscles: 'Forearms, Core', sets: 3, reps: '40 m', icon: '🧳' },
  ],
  cardio: [
    ...
    { id: 'c9', name: 'Elliptical', muscles: 'Full Body, Cardio', sets: 1, reps: '25 min', icon: '🏃' },
    { id: 'c10', name: 'Stair Climber', muscles: 'Legs, Cardio', sets: 1, reps: '20 min', icon: '🪜' },
    { id: 'c11', name: 'Swimming', muscles: 'Full Body', sets: 1, reps: '30 min', icon: '🏊' },
    { id: 'c12', name: 'Incline Walk', muscles: 'Legs, Cardio', sets: 1, reps: '30 min', icon: '🚶' },
    { id: 'c13', name: 'Sprint Intervals', muscles: 'Legs, Cardio', sets: 8, reps: '30 sec', icon: '🏃' },
    { id: 'c14', name: 'Jumping Jacks', muscles: 'Full Body', sets: 3, reps: '45 sec', icon: '⏫' },
    { id: 'c15', name: 'Skater Jumps', muscles: 'Legs, Cardio', sets: 3, reps: '30 sec', icon: '⛸️' },
    { id: 'c16', name: 'Bear Crawl', muscles: 'Full Body, Core', sets: 3, reps: '20 m', icon: '🐻' },
    { id: 'c17', name: 'Assault Bike', muscles: 'Full Body, Cardio', sets: 5, reps: '45 sec', icon: '🚴' },
    { id: 'c18', name: 'Shadow Boxing', muscles: 'Shoulders, Core', sets: 3, reps: '3 min', icon: '🥊' },
  ],
  fatLoss: [
    ...
    { id: 'f7', name: 'Burpee Box Jump', muscles: 'Full Body', sets: 4, reps: '10', icon: '🔥' },
    { id: 'f8', name: 'Dumbbell Thruster', muscles: 'Legs, Shoulders', sets: 4, reps: '12', icon: '🏋️' },
    { id: 'f9', name: 'Mountain Climber Sprint', muscles: 'Core, Cardio', sets: 4, reps: '40 sec', icon: '⛰️' },
    { id: 'f10', name: 'Jump Lunge', muscles: 'Quads, Glutes', sets: 3, reps: '20', icon: '🦵' },
    { id: 'f11', name: 'Medicine Ball Slam', muscles: 'Full Body, Core', sets: 4, reps: '15', icon: '🏐' },
    { id: 'f12', name: 'Russian Twist', muscles: 'Core, Abs', sets: 3, reps: '20', icon: '🌀' },
    { id: 'f13', name: 'Sled Push', muscles: 'Legs, Full Body', sets: 4, reps: '20 m', icon: '🛷' },
    { id: 'f14', name: 'Renegade Row', muscles: 'Back, Core', sets: 3, reps: '12', icon: '💪' },
    { id: 'f15', name: 'High Plank Hold', muscles: 'Core, Shoulders', sets: 3, reps: '45 sec', icon: '💪' },
    { id: 'f16', name: 'Devil Press', muscles: 'Full Body', sets: 4, reps: '10', icon: '🔥' },
  ],
  muscleGain: [
    ...
    { id: 'm9', name: 'Dumbbell Pullover', muscles: 'Chest, Back', sets: 3, reps: '12', icon: '🏋️' },
    { id: 'm10', name: 'Leg Extension', muscles: 'Quads', sets: 3, reps: '12-15', icon: '🦵' },
    { id: 'm11', name: 'Hack Squat', muscles: 'Quads, Glutes', sets: 4, reps: '10-12', icon: '🦵' },
    { id: 'm12', name: 'Chest-Supported Row', muscles: 'Back, Rear Delts', sets: 4, reps: '10-12', icon: '💪' },
    { id: 'm13', name: 'Arnold Press', muscles: 'Shoulders, Triceps', sets: 3, reps: '10-12', icon: '🏋️' },
    { id: 'm14', name: 'Cable Lateral Raise', muscles: 'Shoulders', sets: 3, reps: '12-15', icon: '🏋️' },
    { id: 'm15', name: 'Incline Dumbbell Curl', muscles: 'Biceps', sets: 3, reps: '10-12', icon: '💪' },
    { id: 'm16', name: 'Overhead Tricep Extension', muscles: 'Triceps', sets: 3, reps: '12', icon: '💪' },
    { id: 'm17', name: 'Glute Bridge', muscles: 'Glutes, Hamstrings', sets: 3, reps: '15', icon: '🦵' },
    { id: 'm18', name: 'Standing Calf Raise', muscles: 'Calves', sets: 4, reps: '15', icon: '🦵' },
    { id: 'm19', name: 'Cable Crunch', muscles: 'Core, Abs', sets: 3, reps: '15', icon: '🌀' },
    { id: 'm20', name: 'Hanging Leg Raise', muscles: 'Core, Abs', sets: 3, reps: '12-15', icon: '🔝' },
  ]
};
